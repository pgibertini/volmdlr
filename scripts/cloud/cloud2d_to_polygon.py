...
import volmdlr
import math
def simplify_test(polygon, angle_precision = 5):
    new_polygon_points = []
...
def simplify_test2(polygon, min_distance = 1e-3, angle_precision = 5):
    new_polygon_points = []
    pos1, pos2, pos3 = 0, 1, 2
...
for poly in polys :
    ...
    new_polygon_points2 = simplify_test2(poly, angle_precision = 20)
